module.exports = {
    "RECIPE_EN_US" : {
        "agile": "Agile means the ability to create and respond to change in order to succeed in an uncertain and turbulent environment.  Agile Software Development is an umbrella term for a set of methods and practices.  Solutions evolve through collaboration between self-organizing, cross-functional teams utilizing an incremental development strategy.",
        ...
        "sprint planning": "Sprint planning is a Meeting to negotiate the scope for next Sprint where the team pulls in work from the product Owner’s prioritized backlog.",
        ...
        "scrum master": "A scrum master is one the most important role (along with product owner) in a scrum based approach. Scrum master is responsible for daily standup meetings and tracking the overall progress. It is the duty of scrum master to make sure the team is not blocked at any point of time due to external or internal issues.",
